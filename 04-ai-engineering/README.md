...
> 这一层讲我们怎么用 AI 建成并日常运营前面三层的所有系统。它与烤串、门店、供应链都无关——任何行业的小团队都能照抄,所以很可能是全书对同行最值钱的一层。

## 读完你会知道

- 为什么「极小团队 + AI」能维持一套全链路系统的日常迭代,大部分需求当天或次日交付
- AI 工程的本质不是「让 AI 写代码」,而是一套**知识工程**:把团队脑子里的东西变成 AI 可读的文档
- 我们的四块拼图各管什么:机器人体系、CLAUDE.md、跨会话记忆、质量纪律
- 这四块的阅读顺序,以及哪一块最该先抄
...
能做到这一点,靠的不是某个神奇 prompt,而是长期积累出来的一套工程化方法。这一层把它拆成四篇。
...
这是一个飞轮:知识越全 → AI 产出越准 → 迭代越快 → 新教训越多 → 沉淀回文档 → 知识更全。四篇文章分别对应飞轮的四个环节。如果你只想先抄一块,从 [CLAUDE.md 实践](claude-md-practice.md)开始——它成本最低、见效最快,其余三块都建在它之上。
