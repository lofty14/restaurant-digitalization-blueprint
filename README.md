...
直观感受一下各个端长什么样。本仓不放真实截图(真实界面带经营数据),以下为按真实系统结构绘制的**界面示意图,数据均为虚构**。

**管理端 Web · 运营总览** —— 总部同学的日常主页:营业额、门店、订货、经营分一屏看完

![管理端运营总览示意图](assets/screens/admin-console.svg)

**元财务 · 记账凭证** —— 自建内账引擎,九成以上凭证由订货/采购/收付等业务事件自动生成

![元财务记账凭证示意图](assets/screens/finance-ledger.svg)

| 飞书 · 改码机器人(需求 → AI 改码 → 人审批 → 部署) | 个微门店群 · 聊天即操作(录营业额 / 兑积分) |
|---|---|
| ![改码机器人对话示意图](assets/screens/bot-codefix.svg) | ![门店群聊天办事示意图](assets/screens/wechat-chatops.svg) |

**门店小程序 · 订货商城** —— 店长手机下单,冷链/快递分渠道,购物车原子同步

<img src="assets/screens/miniapp-order.svg" width="320" alt="门店小程序订货商城示意图">
