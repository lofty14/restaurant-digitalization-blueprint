...
> 我们是 **原串**(一家真实运营中的平价烤串连锁品牌,官网 [ycbbq.cn](https://www.ycbbq.cn)),用「极小技术团队 + AI」从零建成了覆盖订货、库存、生产、财务、门店运营、拓店招商的全链路数字化系统。
...
### [04 · AI 工程实践](04-ai-engineering/README.md) — 极小团队干出数倍产能的方法
...
本仓库由原串技术团队维护。初稿由我们自己的 AI 工程体系起草(方法论就在 [04 层](04-ai-engineering/README.md)),人工逐页复核机密红线后发布。欢迎提 issue 交流;涉及配方、财务与真实经营数据的问题恕不回答。

## 声明

- 全书示例数字均为虚构,不构成任何经营或投资建议。
- 方案以烤串/烧烤连锁为背景写成,其他餐饮业态请自行映射。
- License:拟采用 CC BY 4.0(文档许可),发布前定稿;定稿前默认保留所有权利,引用或转载请先联系我们。
